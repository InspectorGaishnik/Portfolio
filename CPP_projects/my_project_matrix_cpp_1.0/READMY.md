...
- Для использования необходимо создать main.cpp, объявить в нем matrix_oop.h как заголовочный файл и при компиляции исполняемого файла, подключать библиотеку matrix_oop.a:  
...
cd project-folder/CPP_projects/my_project_matrix_cpp_1.0/src/
