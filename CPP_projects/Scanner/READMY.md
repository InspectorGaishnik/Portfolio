...
o Логируемая информация:  
▪ Путь к файлу 
▪ Хеш
▪ Вердикт  
o В качестве лога используется текстовый файл, путь к которому передается
на вход утилите
...
o git clone https://github.com/username/project-name.git.
- Перейти в папку с склонированным проектом:  
o cd project-name/src/build/
